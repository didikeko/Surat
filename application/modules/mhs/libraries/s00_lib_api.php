...
class S00_lib_api {
	...
	/*
	Fungsi Tambahan di S00_lib_api.php
	By: Habibi Mustafa 	
	*/

	function post_api($api_kode, $api_subkode, $api_search, $api_url){
		$param = array('api_kode' => $api_kode, 'api_subkode' => $api_subkode, 'api_search' => $api_search);;
		return $this->get_api_json($api_url, 'POST', $param);
	}


	function func_konek_api_exe($url,$post,$method){
		$CI=&get_instance();
		$username="exec";
		$password="exec1245";
		////////////////////////
