...
$nama_surat ='
<b><u style="border: 1px;">SURAT KETERANGAN PINDAH STUDI</u><b><br>
Nomor : '.$nomor.'
';
$txt = '<p>Yang bertanda tangan di bawah ini Dekan '.$fkl.' Universitas Islam Negeri Sunan Kalijaga Yogyakarta menerangkan bahwa : <p><br>
<table>
    <tr>
...
adalah mahasiswa Fakultas '.$fkl.' UIN Sunan Kalijaga Yogyakarta, mahasiswa tersebut: Tercatat pada Semester I Tahun Akademik 2015/2016 sampai dengan Semester '.$smt.' Tahun Akademik '.$thn_akademik.' pada Program Studi '.$prodi.'.<br><br>

Surat keterangan diterbitkan sebagai salah satu syarat untuk meneruskan studi di Perguruan Tinggi lain.<br><br>
Demikian agar dapat dipergunakan sebagaimana mestinya.';
$txt2 = '<table>
<tr>
    <td></td>
    <td></td>
    <td align="L" width="200px">Yogyakarta, '.$dd.' '.$bulan.' '.$yy.' <br>
		a.n. Dekan<br>
...
2. Bagian Akademik Biro AAAK;<br>
...
$pdf->write2DBarcode($nomor, 'QRCODE,L', 20, 187, 20, 20, $style, 'N');
